            ...
            <div className="navigation-burger-wrapper">
              ...
              {/* <div className="languages-navigation-anchors">
                ...
                <ul className="navigation-languages">
                  <li>
                    <NavLink className={"navigation-lag " + (currentLanguage === item.slug ? 'active' : '')} to={item.relativeUrl + "/home"}>DE</NavLink>
                    <NavLink className={"navigation-lag "} to={"test"}>DE</NavLink>
                  </li>
                  ...
                  <li>
                    <NavLink className={"navigation-lag " + (currentLanguage === item.slug ? 'active' : '')} to={item.relativeUrl + "/home"}>FR</NavLink>
                    <NavLink className={"navigation-lag "} to={<WebsiteFr />}>FR</NavLink>
                  </li>
                </ul>
              </div> */}
            ...
            <div className="teaserSpot-content">
              <div className="teaserSpot-img">
                <a href="https://www.facebook.com/WePublish.Community/">
                  <img src="https://karmarun-res.cloudinary.com/image/upload/q_60/w_279/h_279/v1498563099/wepublish/rrbxwstvtli3sv7vbpn0.png" alt="we are" />
                </a>
              </div>
        ...
        <footer id="footer">
          <div className="footer-wrapper">
            ...
            <div className="footer-right" onClick={this.backToTop}>
              <h3>Back to top</h3>
              <img className="footer-img" src="https://karmarun-res.cloudinary.com/image/upload/q_60/v1498563126/wepublish/ktitdcd4cuavgwps4jyr.png" alt="back to top" />
            </div>
          </div>
        </footer>
